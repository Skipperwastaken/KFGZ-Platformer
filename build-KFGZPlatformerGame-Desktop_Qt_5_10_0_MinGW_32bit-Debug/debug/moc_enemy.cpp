...
#include "../../KFGZPlatformerGame/enemy.h"
...
QT_MOC_LITERAL(3, 11, 10), // "prepAttack"
QT_MOC_LITERAL(4, 22, 6), // "attack"
QT_MOC_LITERAL(5, 29, 17), // "checkAttackHitbox"
QT_MOC_LITERAL(6, 47, 12), // "finishAttack"
QT_MOC_LITERAL(7, 60, 3) // "die"

    },
    "Enemy\0hit\0\0prepAttack\0attack\0"
    "checkAttackHitbox\0finishAttack\0die"
};
...
void Enemy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->hit(); break;
        case 1: _t->prepAttack(); break;
        case 2: _t->attack(); break;
        case 3: _t->checkAttackHitbox(); break;
        case 4: _t->finishAttack(); break;
        case 5: _t->die(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Enemy::hit)) {
                *result = 0;
                return;
            }
        }
