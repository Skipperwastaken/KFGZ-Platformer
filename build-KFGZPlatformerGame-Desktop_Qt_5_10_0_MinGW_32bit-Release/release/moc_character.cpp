...
#include "../../KFGZPlatformerGame/character.h"
...
QT_MOC_LITERAL(3, 16, 5), // "moved"
QT_MOC_LITERAL(4, 22, 6), // "amount"
QT_MOC_LITERAL(5, 29, 4), // "move"
QT_MOC_LITERAL(6, 34, 11) // "stopSliding"

    },
    "Character\0died\0\0moved\0amount\0move\0"
    "stopSliding"
};
...
void Character::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Character::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Character::moved)) {
                *result = 1;
                return;
            }
        }
